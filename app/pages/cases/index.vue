<script setup>
	...
	useSeoMeta({
		...
		description: 'Marcus Beladona Portfolio Cases | Product Designer | UX/UI Designer',
		ogTitle: 'Marcus Beladona',
		ogDescription: 'Marcus Beladona Portfolio Cases | Product Designer | UX/UI Designer',
	})
</script>
